 ...
 * TestMs - Test Class
 *
 * This class provides a basic testing framework for the microservice TestMs. It was
...
public class RESTfulExampleTest {
  ...
  /**
   * 
   * Test for the getTrackInJSON method.
   * 
   */
  @Test
  public void testgetTrackInJSON() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "//get", track.toJSONString(),
        MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testgetTrackInJSON': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
